...
export default function DailyPuzzleHeroCard() {
  ...
  return (
    ...
    >
      <PressableCard href="/daily" accent="gold" padding="lg" bevel>
        <div className="flex items-start justify-between gap-4 mb-3">
          ...
          {bestStreak > 0 && (
            <div
              ...
              style={{ background: "rgba(255,201,74,0.14)", color: "var(--pw-gold)", border: "1px solid rgba(255,201,74,0.3)" }}
            >
              🔥 {bestStreak}
            </div>
          )}
        ...
        <div
          ...
          style={{ background: "var(--pw-gold)", color: "#0B0E1A" }}
        >
          {allDone ? "View Results" : "Play Now"} &rarr;
        </div>
      </PressableCard>
    </motion.div>
  );
